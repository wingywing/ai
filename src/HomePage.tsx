    ...
    <home-page>
      <motion.div className="main-grid">
        <motion.div className="section title" id="title">
          ...
          <motion.h1>
            “In&nbsp;the <span className="new-line" />
            style <span className="new-line desktop" />
            of <span className="new-line tablet desktop" />
            wngpng”
          </motion.h1>
          <motion.p className="caption">
            Fears and <span className="new-line" /> reflections on the{" "}
        ...
        <motion.div className="section intro" id="intro">
          ...
          >
            <motion.h2>
              On art and <span className="new-line tablet" />
              artificial <span className="new-line tablet" />
              intelligence
            </motion.h2>
            <motion.div>
              <motion.p>
        ...
        <motion.div className="section experiment" id="experiment">
          ...
          >
            <motion.h2>
              The <span className="new-line tablet" />
              experiment
            </motion.h2>
        ...
        <motion.div className="section conclusion" id="conclusion">
          ...
          >
            ...
            <span className="new-line desktop" />
            is <span className="not">not</span> in the style of{" "}
            <span className="new-line desktop" />
            Wing Pang
          </motion.blockquote>
          <motion.div className="paragraphs">
